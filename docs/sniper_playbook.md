...
* Creator fee ≤ 5 %
* Revoked mint/freeze
* Rug-check (ej blockerande om exit skyddad):
...
* Träffar LaunchLab `Initialize` + Cupsyy-signal: \~25 pooler
* Trades vi genomför: \~15–20
* Lyckade trades (≥ 0 % ROI): \~12–16
* Snittvinst/trade: 2–5 SOL \* 3–5 % = \~0.08–0.25 SOL
* Estimerad månadsvinst: **1.0–3.5 SOL** (efter slippage + fees)
